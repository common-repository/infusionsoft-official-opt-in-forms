...
$more_info_hint_text = sprintf( '<a href="%2$s" target="_blank">%1$s</a>',
	__( 'Click here for more information', 'infusionsoft' ), esc_url( 'http://www.keap.com' ) );
...
$inf_dashboard_options_all = array(
	...
	'load_in' => array(
		...
		'click_trigger'    => array(
			...
			'name'            => 'click_trigger',
			'hint_text'       => __( 'Adds new onclick shortcode option to Keap editor when editing a page / post',
				'infusionsoft' ),
			'default'         => false,
			'validation_type' => 'boolean',
